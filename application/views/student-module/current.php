<div class="sixteen wide column filter-container right-side">
	<div class="dashboard-filter">
		<div class="ui five wide column stackable grid">
			<div class="four wide column"><a href="<?php echo base_url() . 'dashboard'; ?>"
					class="ui button yes">Current Class</a></div>
...
<div class="six wide computer sixteen wide tablet column subjectList">
	<div class="studentSubject">
		...
		<div class="subject-container">
			<?php foreach($currentSubject as $subject){ ?>
			<div class="subject">
...
<div class="sixteen wide column score-container">
	<div class="dashboard-table">
		<table id="studentScore" class="ui celled table" style="width:100%">
			...
			<tbody>
				<?php foreach($currentScores as $score){ ?>
				<tr>
					...
					<td><a href="<?php echo base_url('Dashboard/request/' . $score['subjectID']); ?>" class="tiny ui button reqReview">Request
							Re-review</a></td>
				</tr>
				<?php } ?>
			</tbody>
